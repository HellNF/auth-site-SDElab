...
export function SSOLoginButton({ provider, onFlowStart }: SSOLoginButtonProps) {
  ...
  return (
    <Button onClick={handleLogin} disabled={isLoading} className={`w-full ${config.className}`} size="lg">
